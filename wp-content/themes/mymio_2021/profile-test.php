                        ...
                        <section class="lk-form-container">
                            ...
                            $form_settings = [
                                ...
                                'form_fields' => [
                                    ...
                                    [
                                        'kind' => 'text_block',
                                        'caption' => 'Законный представитель подопечного',
                                    ...
                                    [
                                        ...
                                        'question' => 'Кем вы приходитесь подопечному?',
                                        'with_input' => false,
...
<br>
<span style="display:inline-block;width: 120px;font-weight: 800;">Например:</span><span style="color: #009D9A;">Московская область, город Химки, ул. Мира, д.16, корп.1, кв.33</span>
<br><br>
                                ...
                                $form_settings = [
                                    ...
                                    'form_fields' => [
                                        ...
                                        [
                                            ...
                                            'with_input' => false,
                                            'label_for_input' => '',
                                            'question' => 'Какая мутация выявлена?',
                                        ...
                                        [
                                            'kind' => 'text_block',
                                            'caption' => 'Сопутствующие диагнозы',
                                ...
                                $form_settings = [
                                    ...
                                    'form_fields' => [
                                        ...
                                        [
                                            ...
                                            'question' => 'Какие двигательные возможности у сына на данный момент?',
                                            'options' => [
                                                'Ходит сам',
                            ...
                            <div class="lk-form__tab_content">
                                ...
                                $form_settings = [
                                    ...
                                    'form_fields' => [
                                        ...
                                        [
                                            'kind' => 'radio',
                                            'question' => 'Есть ли у вашего сына контрактуры(состояние, при котором конечность не может быть полностью согнута или разогнута)?',
                                            'name' => 'is_contracture',
                                            'required' => true,
                                            'items' => [
                                                'Да',
...
Выберите подходящие варианты. Обычно это пульмонолог или врач-реаниматолог, но у вас может оказаться свой вариант ответа',
                            ...
                            <div class="lk-form__tab_content">
                                <?php $form_settings = [
                                    ...
                                    'tab' => '12',
                                    'name' => 'confirmation',
                                    'success_msg' => 'Мы благодарим вас за участие в Регистре пациентов с миодистрофией Дюшенна/Беккера. Вы заполнили всю необходимую информацию, мы получили вашу анкету. В ближайшее время координатор фонда свяжется с вами.',
                                    'form_fields' => [
                                        [
                                            'kind' => 'phone-confirm',
//                                            'required' => true,
